    ...
    if (_formKey.currentState!.validate()) {
      setState(() {
        ...
        if (isEditing) {
          ...
          context.read<ContactProvider>().removeContact(selectedContactIndex);
          isEditing = false;
          editMessage = ''; // Clear the edit message
        }

        // Add the new or edited contact using the provider
      ...
      print('data_kontak : ${context.read<ContactProvider>().dataKontak}');
    }
  }
          ...
          child: Consumer<ContactProvider>(
            builder: (context, contactProvider, child) {
              return ListView.builder(
                itemCount: contactProvider.dataKontak.length,
                itemBuilder: (BuildContext context, int index) {
                  String title = contactProvider.dataKontak[index]["title"] ??
                      "Nama Tidak Tersedia";
                  String subtitle = contactProvider.dataKontak[index]
                          ["subtitle"] ??
                      "Nomor Tidak Tersedia";
                  String initial = title.isNotEmpty ? title[0] : "?";
                  String date = contactProvider.dataKontak[index]["date"] ??
                      "Tanggal Tidak Tersedia";
                  String color = contactProvider.dataKontak[index]["color"] ??
                      "Color Tidak Tersedia";
                  String fileName = contactProvider.dataKontak[index]
                          ["fileName"] ??
                      "File Tidak Tersedia";
                    ...
                    trailing: Wrap(
                      children: [
                        ...
                        IconButton(
                          ...
                          onPressed: () {
                            // Remove the contact using the provider
